...
func ProTipsOslo () {
	...
	case utenKelvin > 18 && index.Wind.Speed < 4:
		index.Main.TempA = "I dag er det norsk sommmer med lav vindstyrke. På tide å dra frem shortsen"
	case utenKelvin >= 18 && index.Wind.Speed > 4:
		index.Main.TempA = "I dag blir det varmt men høy vindstyrke, husk vindjakke"
	case utenKelvin < 18 && utenKelvin > 13:
		index.Main.TempA = "Det kan bli kaldt utover kvelden, ta gjerne på et skjerf for å unngå forkjølelse!"
	case utenKelvin <= 13 && utenKelvin > 4:
		index.Main.TempA = "Husk D-vitaminer da solen ikke er like sterk. Det er enda vår!"
	case utenKelvin <= 4:
		index.Main.TempA = "Kle på deg"
	case utenKelvin < 4:
...
func ProTipsTrondheim () {
	...
	var utenKelvin = index2.Main.Temp - 273.
	...
	case utenKelvin >= 18 && index2.Wind.Speed > 4:
		index2.Main.TempB = "I dag blir det varmt men høy vindstyrke, husk vindjakke!"
	case utenKelvin < 18 && utenKelvin > 13:
		index2.Main.TempB = "Det kan bli kaldt utover kvelden, ta gjerne på et skjerf for å unngå forkjølelse!"
	case utenKelvin <= 13 && utenKelvin > 4:
		index2.Main.TempB = "Husk D-vitaminer da solen ikke er like sterk. Det er enda vår!"
	case utenKelvin <= 4:
		index2.Main.TempB = "Kle på deg"
	case utenKelvin < 4:
...
func ProTipsStavanger () {
	...
	case utenKelvin >= 18 && index3.Wind.Speed > 4:
		index3.Main.TempC = "I dag blir det varmt men høy vindstyrke, husk vindjakke"
	case utenKelvin < 18 && utenKelvin > 13:
		index3.Main.TempC = "Det kan bli kaldt utover kvelden, ta gjerne på et skjerf for å unngå forkjølelse!"
	case utenKelvin <= 13 && utenKelvin > 4:
		index3.Main.TempC = "Husk D-vitaminer da solen ikke er like sterk. Det er enda vår!"
	case utenKelvin <= 4:
		index3.Main.TempC = "Kle på deg"
	case utenKelvin < 4:
...
func main() {
	...
	openBrowser("http://localhost:8080/2")
